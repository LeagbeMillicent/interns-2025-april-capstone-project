...
interface LoadingWrapperProps {
  ...
  isLoading?: boolean;
  minLoadingTime?: number; // Minimum time to show the loading animation in ms
}
...
export default function LoadingWrapper({ 
  ...
  }, [externalIsLoading, minLoadingTime]);
